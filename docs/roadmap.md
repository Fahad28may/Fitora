...
- Frontend tests ✅ §48 — jest-expo + React Native Testing Library, 125 tests across API-client behaviour, the health-sync layer, components (BarcodeScanner, HealthSyncCard), screens (Settings, Log activity), and form validation (register). Wired into CI as a required step
